...
用法:
    python scripts/check/models.py                     # 测试所有类别，每模型 5 次
    python scripts/check/models.py -n 10               # 每模型 10 次
    python scripts/check/models.py -c fast             # 只测 fast 类
    python scripts/check/models.py --native            # 使用项目 ModelClient
    python scripts/check/models.py --stream            # 流式模式
