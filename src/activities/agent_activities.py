"""
Temporal Activities for HpAgent.

Each Activity wraps a single non-deterministic operation (API call, tool execution, I/O).
Dependencies are injected at Worker startup via set_dependencies() to keep activities stateless.
"""
...
async def build_context_activity(
    ...
    from common.types import Event, ChannelType, EventType
